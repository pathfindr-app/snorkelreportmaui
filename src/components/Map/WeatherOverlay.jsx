function WeatherOverlay({ weather }) {
  ...
  return (
    <div className="absolute top-20 right-4 z-10 glass rounded-lg p-4 min-w-[140px]">
      <div className="text-ocean-300 text-xs font-medium mb-2">Current Weather</div>
      ...
      {/* Description */}
      {weather.description && (
        <div className="text-sm text-ocean-200 capitalize mb-3">{weather.description}</div>
      )}

      {/* Details */}
      <div className="space-y-1.5 text-xs">
        {/* Wind */}
        <div className="flex items-center justify-between text-ocean-300">
